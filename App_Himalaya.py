...
logos_expediciones = ('Imagenes/logos_expediciones.png')
...
#---LECTURA---#
expeditions = pd.read_csv('CSV/himalayan_expeditions_copy.csv')
members = pd.read_csv('CSV/members_copy.csv')
peaks = pd.read_csv('CSV/peaks_copy.csv')
peaks_original = pd.read_csv('CSV/peaks.csv')
expeditions_original = pd.read_csv('CSV/expeditions.csv')

#---MENU PRINCIPAL---#
menu_principal = option_menu(None, ['📌 Introduccion', "📈 Analisis Exploratorio", "🚧 Power Bi", "🌐 Modelo", "🏆 Conclusión"], orientation="horizontal",
                             styles={"container": {"background-color": "#000033", "border-radius": "50px"},})

#---INTRODUCCION---#
if menu_principal == '📌 Introduccion':
...
#-EXPEDICION EDA-#
if menu_principal == '📈 Analisis Exploratorio':
    ...
    if sidebar == 'Expedicion':
        ...
        with col3:
            imagen_amadablam = ('Imagenes/imagen3.png')
            st.image(imagen_amadablam,width=10, use_column_width=True)
        
        with col7:
            imagen3 = ('Imagenes/grafica_picos_otoño.png')
        ...
        with col5:
            imagen5 = ('Imagenes/5_razones_abandono.png')
            st.image(imagen5,width=1070)
        with col6:
            imagen6 = ('Imagenes/mal_tiempo.jpg')
        ...
        with col6:
            imagen_oxigeno = ('Imagenes/oxigeno.jpg')
        ...
        #---PREGUNTA QUINTA---#
        st.markdown("<div style='padding: 10px; border-radius: 5px;'><h1 style='text-align: center; color: #ffffff; font-size: 40px; margin: 0; text-shadow: 6px 6px 6px #000000;'>¿Cuáles son las 50 expediciones con mas miembros?</h1></div>", unsafe_allow_html=True)
        miembros_expediciones = ('Imagenes/50miembros_expediciones.PNG')
    ...
    #---PREGUNTA PRIMERA---#
        ...
        with col9:
            climbed_vs_unclimbed = ('Imagenes/grafico_climbed_unclimbed.png')
            st.image(climbed_vs_unclimbed,width=800)
            
        with col10:
            cima = ('Imagenes/cima.jpg')
        ...
        with colpaises1:
            primeras_ascensiones = ('Imagenes/japon_nepal_primeras.jpg')
        ...
        with col12:
            imagen_letal = ('Imagenes/picos_letales.png')
    ...
    #---PREGUNTA PRIMERA---#
        st.markdown("<div style='padding: 10px; border-radius: 5px;'><h1 style='text-align: center; color: #ffffff; font-size: 40px; margin: 0; text-shadow: 6px 6px 6px #000000;'>¿Cuál ha sido el suceso mas grave en la cordillera del Himalaya por españoles?</h1></div>", unsafe_allow_html=True)
        imagen6 = ('Imagenes/imagen6.PNG')
        st.image(imagen6,use_column_width=True)
        
        españoles_fallecidos = ('Imagenes/5españoles_fallecidos.PNG')
    ...
    #---PREGUNTA SEGUNDA---#
        ...
        miembros_fallecidos = ('Imagenes/miembros_afectados.png')
    ...
    #---PREGUNTA TERCERA---#
        st.markdown("<div style='padding: 10px; border-radius: 5px;'><h1 style='text-align: center; color: #ffffff; font-size: 40px; margin: 0; text-shadow: 6px 6px 6px #000000;'>¿Qué roles son mas habituales en una expedicion?</h1></div>", unsafe_allow_html=True)
        
        col18, col19 = st.columns(2)
        with col18:
            imagen5 = ('Imagenes/roles_expediciones.png')
    ...
    #---PREGUNTA QUINTA---#
        ...
        with col21:
            primera_mujer_everest = ('Imagenes/primera_mujer_everest.PNG')
...
if menu_principal == '🏆 Conclusión':
    ...
    personas_everest_gif = ('Imagenes/videoagif.gif')
    basura_en_everest = ('Imagenes/basura_en_everest.jpg')
